...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Urban Food</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#coffee" class="dropdown-item">BAKERY ITEMS</a>
                                   <a href="products.php#esp" class="dropdown-item">DAIRY PRODUCTS</a>
                                   <a href="products.php#drinks" class="dropdown-item">FRUITS & VEGITABLES</a>
                                   <a href="products.php#food" class="dropdown-item">HANDMADE CRAFTS</a>
                               </div>
